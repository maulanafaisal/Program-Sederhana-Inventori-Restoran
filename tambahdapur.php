        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center">Tambah Data Dapur</h1>
                    <hr>
                    <!-- Form Tabel -->
                   <br>
                   <form method ="POST" action="tdapur.php">
                        ...
                        <a href="dapur.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"
