        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center">Tambah Data Sayuran</h1>
                    <hr>
                    <!-- Form Tabel -->
                   <br>
                   <form method ="POST" action="tsayuran.php">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                            <input type="text" class="form-control" id="hargaperkg" name ="hargaperkg">
                            </div>
                        </div>

                        <div class="row mb-3">
                            <label for="jumlah" class="col-sm-2 col-form-label">Jumlah(perkg)</label>
                            <div class="col-sm-10">
                        ...
                        <a href="sayuran.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"
                        style="padding: 7px 10px; font-weight: 500; font-size: 15px;">
                        <i class="fas fa-back fa-sm text-white"></i>Kembali</a>
                    </form>
