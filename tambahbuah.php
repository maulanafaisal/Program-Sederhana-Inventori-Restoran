        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 text-center">Data Buah</h1>
                    <hr>
                    <!-- Form Tabel -->
                   <br>
                   <form method ="POST" action="tbuah.php">
                        ...
                        <a href="buah.php" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"
